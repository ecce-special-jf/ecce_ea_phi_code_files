...
// Wed Oct 13 23:48:16 2021 by ROOT version 6.22/02
// from TTree event_tree/event_tree
// found on file: sixB/nonsat/out_xaa.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nHits;
   Int_t           hits_layerID[1699];   //[nHits]
   Int_t           hits_trueID[1699];   //[nHits]
   Float_t         hits_x[1699];   //[nHits]
   Float_t         hits_y[1699];   //[nHits]
   Float_t         hits_z[1699];   //[nHits]
   Float_t         hits_x2[1699];   //[nHits]
   Float_t         hits_y2[1699];   //[nHits]
   Float_t         hits_z2[1699];   //[nHits]
   Float_t         hits_t[1699];   //[nHits]
   Float_t         hits_edep[1699];   //[nHits]
   Int_t           nTracks;
   ...
   Int_t           tower_BECAL_N;
   Float_t         tower_BECAL_E[303];   //[tower_BECAL_N]
   Int_t           tower_BECAL_iEta[303];   //[tower_BECAL_N]
   Int_t           tower_BECAL_iPhi[303];   //[tower_BECAL_N]
   Int_t           tower_BECAL_trueID[303];   //[tower_BECAL_N]
   Int_t           tower_HCALIN_N;
   Float_t         tower_HCALIN_E[70];   //[tower_HCALIN_N]
   Int_t           tower_HCALIN_iEta[70];   //[tower_HCALIN_N]
   Int_t           tower_HCALIN_iPhi[70];   //[tower_HCALIN_N]
   Int_t           tower_HCALIN_trueID[70];   //[tower_HCALIN_N]
   ...
   Float_t         tower_HCALOUT_E[6];   //[tower_HCALOUT_N]
   Int_t           tower_HCALOUT_iEta[6];   //[tower_HCALOUT_N]
   Int_t           tower_HCALOUT_iPhi[6];   //[tower_HCALOUT_N]
   Int_t           tower_HCALOUT_trueID[6];   //[tower_HCALOUT_N]
   ...
   Int_t           tower_FEMC_N;
   Float_t         tower_FEMC_E[161];   //[tower_FEMC_N]
   Int_t           tower_FEMC_iEta[161];   //[tower_FEMC_N]
   Int_t           tower_FEMC_iPhi[161];   //[tower_FEMC_N]
   Int_t           tower_FEMC_trueID[161];   //[tower_FEMC_N]
   Int_t           cluster_FEMC_N;
   Float_t         cluster_FEMC_E[8];   //[cluster_FEMC_N]
   Float_t         cluster_FEMC_Eta[8];   //[cluster_FEMC_N]
   Float_t         cluster_FEMC_Phi[8];   //[cluster_FEMC_N]
   Int_t           cluster_FEMC_NTower[8];   //[cluster_FEMC_N]
   Int_t           cluster_FEMC_trueID[8];   //[cluster_FEMC_N]
   Int_t           tower_EEMC_N;
   Float_t         tower_EEMC_E[141];   //[tower_EEMC_N]
   Int_t           tower_EEMC_iEta[141];   //[tower_EEMC_N]
   Int_t           tower_EEMC_iPhi[141];   //[tower_EEMC_N]
   Int_t           tower_EEMC_trueID[141];   //[tower_EEMC_N]
   Int_t           cluster_EEMC_N;
   Float_t         cluster_EEMC_E[12];   //[cluster_EEMC_N]
   Float_t         cluster_EEMC_Eta[12];   //[cluster_EEMC_N]
   Float_t         cluster_EEMC_Phi[12];   //[cluster_EEMC_N]
   Int_t           cluster_EEMC_NTower[12];   //[cluster_EEMC_N]
   Int_t           cluster_EEMC_trueID[12];   //[cluster_EEMC_N]
   Float_t         vertex_x;
   Float_t         vertex_y;
   Float_t         vertex_z;
   Int_t           vertex_NCont;
   ...
   Int_t           nMCPart;
   Int_t           mcpart_ID[1083];   //[nMCPart]
   Int_t           mcpart_ID_parent[1083];   //[nMCPart]
   Int_t           mcpart_PDG[1083];   //[nMCPart]
   Float_t         mcpart_E[1083];   //[nMCPart]
   Float_t         mcpart_px[1083];   //[nMCPart]
   Float_t         mcpart_py[1083];   //[nMCPart]
   Float_t         mcpart_pz[1083];   //[nMCPart]
   Int_t           mcpart_BCID[1083];   //[nMCPart]
   Int_t           nHepmcp;
   Int_t           hepmcp_procid;
   Float_t         hepmcp_x1;
   Float_t         hepmcp_x2;
...
#ifdef thnew_et_cxx
thnew_et::thnew_et(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("sixB/nonsat/out_xaa.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("sixB/nonsat/out_xaa.root");
      }
...
Int_t thnew_et::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t thnew_et::LoadTree(Long64_t entry)
{
...
void thnew_et::Show(Long64_t entry)
{
...
Int_t thnew_et::Cut(Long64_t entry)
{
